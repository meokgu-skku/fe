...
export default function StoreDetailScreen(props) {
  ...
  const restaurantDetail = async () => {
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  {item.profileImageUrl ? (
                    <Image source={{ uri: item.profileImageUrl }} style={styles.reviewAuthorImage} />
                  ) : (
      ...
      <>
        <View style={styles.entire}>
          <View style={styles.storeImageContainer}>
            <Image source={{ uri: restaurant.restaurant.representativeImageUrl }} style={styles.storeImage}/>
            <ImageModal
              swipeToDismiss={true}
          ...
          <View style={styles.storeInfo}>
            ...
            <View style={styles.contactContainer}>
              ...
              <TouchableOpacity style={styles.contactButton}>
                ...
                <Text style={styles.contactButtonText}>{restaurant.restaurant.ratingAvg.toFixed(1)}</Text>
              </TouchableOpacity>
              <View style={styles.verticalDivider} />
              <AnimatedButton
                style={styles.contactButton}
    ...
    return (
      <>
        <Header title={restaurant.restaurant.name} isBackButton={true} style={{backgroundColor: 'trasparent'}} />
        <FlatList
